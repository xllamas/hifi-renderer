...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get onboardingDacDetail =>
      'Branchez le DAC USB quand vous voulez. Android demande l’autorisation à la connexion — cochez « toujours ouvrir » dans cette demande et il cessera de demander — et le lecteur s’adapte au DAC branché plutôt que d’être configuré pour l’un d’eux.';
  ...
  String errRateNotOffered(String rate) {
    return 'Ce DAC ne prend pas en charge le $rate.';
  }
  ...
  String errTracksSkipped(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count pistes ont été ignorées car elles n’ont pas pu être lues.',
      one: 'Une piste a été ignorée car elle n’a pas pu être lue.',
    );
    return '$_temp0';
  }
}

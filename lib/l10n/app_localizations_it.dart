...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get onboardingDacDetail =>
      'Collega il DAC USB quando vuoi. Android chiede il permesso la prima volta che viene collegato, quindi qui non cՏ nulla da fare, e il riproduttore si adatta al DAC collegato invece di essere configurato per uno in particolare.';

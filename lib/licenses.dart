...
/// Adds the native third-party licenses to the registry Flutter shows.
///
...
/// license page would silently under-report what is being distributed. LGPL,
...
/// constants, so the page cannot drift away from the licenses actually in the
...
void registerThirdPartyLicenses() {
  LicenseRegistry.addLicense(() async* {
    ...
    // appear: their license text lives at the end of the header files rather
